namespace JoycePrint.Web.Tests.TestData
{
    public static class MaterializeCssStyles
    {
        ...
        public static string MaterializeInputGroupInputClassesInitial => "materialize-textarea validate";
        ...
        public static string MaterializeInputGroupInputClassesTouched => "materialize-textarea validate";
        ...
        public static string MaterializeInputGroupIconClassesValid => "material-icons prefix orange-text text-accent-4";

        public static string MaterializeInputGroupInputClassesValid => "materialize-textarea validate";

        public static string MaterializeInputGroupLabelClassesValid => null;

        public static string MaterializeInputGroupValidationLabelClassesValid => "val-msg";

        #endregion

        #region FieldCss InValid

        public static string MaterializeInputGroupIconClassesInValid => "material-icons prefix orange-text text-accent-4";

        public static string MaterializeInputGroupInputClassesInValid => "materialize-textarea validate";

        public static string MaterializeInputGroupLabelClassesInValid => null;

        public static string MaterializeInputGroupValidationLabelClassesInValid => "val-msg";

        #endregion

        #region FieldCss Optional

        public static string MaterializeInputGroupIconClassesOptional => "material-icons prefix orange-text text-accent-4";

        public static string MaterializeInputGroupInputClassesOptional => "materialize-textarea validate";
